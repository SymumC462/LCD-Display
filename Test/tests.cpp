...
void GetWeather_TemperatureAndStatus(Displayer& sut, LCDScreenSpy& lcdSpy, stringstream& outSpy, WeatherClientSpy& weatherSpy)
{
    char arg0[] = "testcmd";
    char arg1[] = "Weather2";
    char* sutargv[] = { arg0, arg1 };
    weatherSpy.SetTempFahrenheit(6);
    weatherSpy.SetStatus("Clear");
...
int main(int argc, char* argv[]) {
    ...
    std::vector<std::function<void(Displayer&, LCDScreenSpy&, stringstream&, WeatherClientSpy&)>> weatherTests = {
        ...
        GetWeather_TemperatureAndStatus
    };
